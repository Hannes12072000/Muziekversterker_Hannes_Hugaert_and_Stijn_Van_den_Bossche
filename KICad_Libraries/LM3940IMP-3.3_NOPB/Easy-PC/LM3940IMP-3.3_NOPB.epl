...
(library Library_1
	...
	(symbolDef "LM3940IMP-3_3_NOPB" (originalName "LM3940IMP-3_3_NOPB")
	...
	(compDef "LM3940IMP-3.3_NOPB" (originalName "LM3940IMP-3.3_NOPB") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "GND_(TAB)") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM3940IMP-3_3_NOPB"))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/ds/symlink/lm3940.pdf")
		(attr "Height" "1.8 mm")
	)
